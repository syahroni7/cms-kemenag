...
<head>
  ...
  <!-- Vendor CSS Files -->
  <link href="{{ asset('blogy-assets/vendor/aos/aos.css') }}" rel="stylesheet">
  <link href="{{ asset('blogy-assets/vendor/bootstrap/css/bootstrap.min.css') }}" rel="stylesheet">
  <link href="{{ asset('blogy-assets/vendor/bootstrap-icons/bootstrap-icons.css') }}" rel="stylesheet">
  <link href="{{ asset('blogy-assets/vendor/glightbox/css/glightbox.min.css') }}" rel="stylesheet">
  <link href="{{ asset('blogy-assets/vendor/swiper/swiper-bundle.min.css') }}" rel="stylesheet">
...
<body class="index-page">
          ...
          <div class="swiper-wrapper">
            <div class="swiper-slide">
              <div class="blog-post-item">
                <img src="blogy-assets/img/blog/blog-post-portrait-1.webp" alt="Blog Image">
            ...
            <div class="swiper-slide">
              <div class="blog-post-item">
                <img src="blogy-assets/img/blog/blog-post-portrait-2.webp" alt="Blog Image">
                <div class="blog-post-content">
                  <div class="post-meta">
            ...
            <div class="swiper-slide">
              <div class="blog-post-item">
                <img src="blogy-assets/img/blog/blog-post-portrait-3.webp" alt="Blog Image">
                <div class="blog-post-content">
                  <div class="post-meta">
            ...
            <div class="swiper-slide">
              <div class="blog-post-item">
                <img src="blogy-assets/img/blog/blog-post-portrait-4.webp" alt="Blog Image">
                <div class="blog-post-content">
                  <div class="post-meta">
            ...
            <div class="swiper-slide">
              <div class="blog-post-item">
                <img src="blogy-assets/img/blog/blog-post-portrait-5.webp" alt="Blog Image">
                <div class="blog-post-content">
                  <div class="post-meta">
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="row gy-4 mb-4">
          <div class="col-lg-4">
            <article class="featured-post">
              <div class="post-img">
                <img src="blogy-assets/img/blog/blog-post-6.webp" alt="" class="img-fluid" loading="lazy">
              </div>
              <div class="post-content">
                <div class="category-meta">
                  <span class="post-category">Health</span>
                  <div class="author-meta">
                    <img src="blogy-assets/img/person/person-f-13.webp" alt="" class="author-img">
          ...
          <div class="col-lg-4">
            <article class="featured-post">
              <div class="post-img">
                <img src="blogy-assets/img/blog/blog-post-7.webp" alt="" class="img-fluid" loading="lazy">
              </div>
              <div class="post-content">
                <div class="category-meta">
                  <span class="post-category">Education</span>
                  <div class="author-meta">
                    <img src="blogy-assets/img/person/person-m-10.webp" alt="" class="author-img">
          ...
          <div class="col-lg-4">
            <article class="featured-post">
              <div class="post-img">
                <img src="blogy-assets/img/blog/blog-post-5.webp" alt="" class="img-fluid" loading="lazy">
              </div>
              <div class="post-content">
                <div class="category-meta">
                  <span class="post-category">Gaming</span>
                  <div class="author-meta">
                    <img src="blogy-assets/img/person/person-f-14.webp" alt="" class="author-img">
        ...
        <div class="row">
          ...
          <div class="col-xl-4 col-lg-6">
            <article class="list-post">
              <div class="post-img">
                <img src="blogy-assets/img/blog/blog-post-9.webp" alt="" class="img-fluid" loading="lazy">
              </div>
              <div class="post-content">
                <div class="category-meta">
                  <span class="post-category">Gaming</span>
          ...
          <div class="col-xl-4 col-lg-6">
            <article class="list-post">
              <div class="post-img">
                <img src="blogy-assets/img/blog/blog-post-10.webp" alt="" class="img-fluid" loading="lazy">
              </div>
              <div class="post-content">
                <div class="category-meta">
                  <span class="post-category">Gaming</span>
          ...
          <div class="col-xl-4 col-lg-6">
            <article class="list-post">
              <div class="post-img">
                <img src="blogy-assets/img/blog/blog-post-2.webp" alt="" class="img-fluid" loading="lazy">
              </div>
              <div class="post-content">
                <div class="category-meta">
                  <span class="post-category">Gaming</span>
          ...
          <div class="col-xl-4 col-lg-6">
            <article class="list-post">
              <div class="post-img">
                <img src="blogy-assets/img/blog/blog-post-1.webp" alt="" class="img-fluid" loading="lazy">
              </div>
              <div class="post-content">
                <div class="category-meta">
                  <span class="post-category">Gaming</span>
          ...
          <div class="col-xl-4 col-lg-6">
            <article class="list-post">
              <div class="post-img">
                <img src="blogy-assets/img/blog/blog-post-3.webp" alt="" class="img-fluid" loading="lazy">
              </div>
              <div class="post-content">
                <div class="category-meta">
                  <span class="post-category">Gaming</span>
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="advertise-1 d-flex flex-column flex-lg-row gap-4 align-items-center position-relative">
          ...
          <div class="content-right position-relative" data-aos="fade-left" data-aos-delay="300">
            <img src="blogy-assets/img/misc/misc-1.webp" alt="Digital Platform" class="img-fluid rounded-4">
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-4">
            <article>
              ...
              <div class="post-img">
                <img src="blogy-assets/img/blog/blog-post-1.webp" alt="" class="img-fluid">
              </div>
              ...
              <div class="d-flex align-items-center">
                <img src="blogy-assets/img/person/person-f-12.webp" alt="" class="img-fluid post-author-img flex-shrink-0">
                <div class="post-meta">
          ...
          <div class="col-lg-4">
            <article>
              ...
              <div class="post-img">
                <img src="blogy-assets/img/blog/blog-post-2.webp" alt="" class="img-fluid">
              </div>
              ...
              <div class="d-flex align-items-center">
                <img src="blogy-assets/img/person/person-f-13.webp" alt="" class="img-fluid post-author-img flex-shrink-0">
                <div class="post-meta">
          ...
          <div class="col-lg-4">
            <article>
              ...
              <div class="post-img">
                <img src="blogy-assets/img/blog/blog-post-3.webp" alt="" class="img-fluid">
              </div>
              ...
              <div class="d-flex align-items-center">
                <img src="blogy-assets/img/person/person-m-10.webp" alt="" class="img-fluid post-author-img flex-shrink-0">
                <div class="post-meta">
          ...
          <div class="col-lg-4">
            <article>
              ...
              <div class="post-img">
                <img src="blogy-assets/img/blog/blog-post-4.webp" alt="" class="img-fluid">
              </div>
              ...
              <div class="d-flex align-items-center">
                <img src="blogy-assets/img/person/person-f-14.webp" alt="" class="img-fluid post-author-img flex-shrink-0">
                <div class="post-meta">
          ...
          <div class="col-lg-4">
            <article>
              ...
              <div class="post-img">
                <img src="blogy-assets/img/blog/blog-post-5.webp" alt="" class="img-fluid">
              </div>
              ...
              <div class="d-flex align-items-center">
                <img src="blogy-assets/img/person/person-m-11.webp" alt="" class="img-fluid post-author-img flex-shrink-0">
                <div class="post-meta">
          ...
          <div class="col-lg-4">
            <article>
              ...
              <div class="post-img">
                <img src="blogy-assets/img/blog/blog-post-6.webp" alt="" class="img-fluid">
              </div>
              ...
              <div class="d-flex align-items-center">
                <img src="blogy-assets/img/person/person-f-15.webp" alt="" class="img-fluid post-author-img flex-shrink-0">
                <div class="post-meta">
  ...
  <footer id="footer" class="footer">
    ...
    <div class="container copyright text-center mt-4">
        <p>© {{ date('Y') }},<strong class="px-1 sitename">Kantor Kemenag Lebak</strong></p>
        <div class="credits">
            <!-- All the links in the footer should remain intact. -->
            <!-- You can delete the links only if you've purchased the pro version. -->
            <!-- Licensing information: https://bootstrapmade.com/license/ -->
            <!-- Purchase the pro version with working PHP/AJAX contact form: [buy-url] -->
            Oleh <a href="#">Prakom Kemenag Lebak</a>
        </div>
    </div>
  ...
  <!-- Vendor JS Files -->
  <script src="{{ asset('blogy-assets/vendor/aos/aos.js') }}"></script>
  <script src="{{ asset('blogy-assets/vendor/bootstrap/js/bootstrap.bundle.min.js') }}"></script>
  <script src="{{ asset('blogy-assets/vendor/glightbox/js/glightbox.min.js') }}"></script>
  <script src="{{ asset('blogy-assets/vendor/php-email-form/validate.js') }}"></script>
  <script src="{{ asset('blogy-assets/vendor/purecounter/purecounter_vanilla.js') }}"></script>
  <script src="{{ asset('blogy-assets/vendor/swiper/swiper-bundle.min.js') }}"></script>
