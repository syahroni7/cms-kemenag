...
@section('content')
    ...
    <main id="main" class="main">
                            ...
                            <table class='table table-bordered display' id="example"
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center">Nama Output Layanan</th>
        ...
        @include('admin.output-layanan._modal')
...
@section('_scripts')
    ...
    <script>
            ...
            buttons: [
                'pageLength', {
                    ...
                    attr: {
                        ...
                        'data-bs-title': 'Tambah Output Layanan',
                        'data-title': 'Tambah Output Layanan',
                        'type': 'button',
                        'id': 'addBtn',
        ...
        $(document).ready(function() {
            table.ajax.url('/output-layanan').load();
            ...
            $(document).on("click", "#editBtn", function() {
                ...
                console.log(data);
                console.log(title);
                $("#id_output_layanan").val(data.id_output_layanan);
                $('#name').val(data.name);
            ...
            $(document).on("click", "#destroyBtn", function() {
                event.preventDefault();
                var idItem = $(this).data('id_output_layanan');
                ...
                swalWithBootstrapButtons.fire({
                    ...
                    if (result.isConfirmed) {
                        var url = "{{ route('output-layanan.destroy', ':id') }}";
