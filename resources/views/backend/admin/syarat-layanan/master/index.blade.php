...
@section('content')
    ...
    <main id="main" class="main">
                            ...
                            <table class='table table-bordered display' id="example"
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center">Nama Syarat Layanan</th>
        ...
        @include('admin.syarat-layanan.master._modal')
...
@section('_scripts')
    ...
    <script>
            ...
            buttons: [
                'pageLength', {
                    ...
                    attr: {
                        ...
                        'data-bs-title': 'Tambah Master Syarat Layanan',
                        'data-title': 'Tambah Master Syarat Layanan',
                        'type': 'button',
                        'id': 'addBtn',
        ...
        $(document).ready(function() {
            table.ajax.url('/syarat-layanan/master').load();
            ...
            $(document).on("click", "#editBtn", function() {
                ...
                console.log(data);
                console.log(title);
                $("#id_master_syarat_layanan").val(data.id_master_syarat_layanan);
                $('#name').val(data.name);
            ...
            $(document).on("click", "#destroyBtn", function() {
                event.preventDefault();
                var idItem = $(this).data('id_master_syarat_layanan');
