...
@section('content')
    ...
    <main id="main" class="main">
                            ...
                            <table class='table table-bordered display' id="example"
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center">Nama Jenis Layanan</th>
        ...
        @include('admin.jenis-layanan._modal')
...
@section('_scripts')
    ...
    <script>
            ...
            buttons: [
                'pageLength', {
                    ...
                    attr: {
                        ...
                        'data-bs-title': 'Tambah Jenis Layanan',
                        'data-title': 'Tambah Jenis Layanan',
                        'type': 'button',
                        'id': 'addBtn',
        ...
        $(document).ready(function() {
            table.ajax.url('/jenis-layanan').load();
